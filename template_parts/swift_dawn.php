...
<section id="swift">
    <div class="two-column-container">
        <div class="column">
            ...
            <?php if($nsfw) { ?>
            <p>
                Under his belly, between his hind legs is a sheath, resembling the look of a normal horse's genitals,
                but the differences become quit clear when he becomes erect, revealing a shaft with a light to dark blue
                gradient. The horsecock would be anything but ordinary as the tip and urethra of the cock can stretch to
                accommodate the traversal of golf ball sized changeling eggs to impregnate pray. The presence of these
                eggs is not absolute however and Swift posses the ability to cum like any normal pony stallion should he
                please, though the seed expelled would be infertile. He gains much more satisfaction from expelling the
                eggs, given the choice.
            </p>
            <?php } ?>
            <p>
        ...
        <div class="column">
            ...
            <ul class="character-details character-colors">
                ...
                <?php if($nsfw) { ?>
                    <li class="swift-peen-base"><span class="detail">Penis Base</span> #1c3fcf</li>
                    <li class="swift-peen-tip"><span class="detail">Penis Tip</span> #0b2691</li>
                <?php } ?>
            ...
            <ul class="character-details character-colors">
                ...
                <?php if($nsfw) { ?>
                    <li class="swift-d-peen"><span class="detail">Penis</span> #4a9ea6</li>
                <?php } ?>
