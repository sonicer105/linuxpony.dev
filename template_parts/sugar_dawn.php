...
<section id="sugar">
    <div class="two-column-container">
        <div class="column">
            ...
            <?php if($nsfw) { ?>
            <p>
                Under her tail, between his hind legs is a fairly innocuous slit unlike a pony mare's pussy. When
                not aroused, the slit blends in, making it easy to miss. Sugar's reproductive system is closer to
                that of amphibians then mammals, laying eggs when reproducing. She has no mammaries but does have a
                anus a little further down her torso.
            </p>
            <?php } ?>
            <p>
