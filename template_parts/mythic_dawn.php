...
<section id="mythic">
    <div class="two-column-container">
        <div class="column">
            ...
            <?php if($nsfw) { ?>
            <p>
                Under her tail, between his hind legs is a mare pussy. The area immediately surrounding her slit and
                anus is a darker shade of gray then the rest of her coat. Lower down between her legs is a set of
                perky mare tits, along with a set of small boobs they are attached to.
            </p>
            <?php } ?>
            <p>
        ...
        <div class="column">
            ...
            <ul class="character-details character-colors">
                ...
                <?php if($nsfw) { ?>
                    <li class="mythic-genitals-area"><span class="detail">Genitals Area</span> #3d3d33</li>
                <?php } ?>
            ...
            <div id="mythic-slider-nav" class="slider-nav" data-slick='{"asNavFor":"#mythic-slider-main"}'>
                ...
                <img data-lazy="/img/flutterthrash-commission-2-sml.<?php echo ($webp)? 'webp' : 'png' ?>" alt="Reference Sheet for Mythic Dawn">
                <?php if($nsfw) { ?>
                <img data-lazy="/img/louvely-commission-1-sml.<?php echo ($webp)? 'webp' : 'jpg' ?>" alt="Reference Sheet for Mythic Dawn">
                <?php } ?>
                <img data-lazy="/img/nekroled-commission-3-alt-sml.<?php echo ($webp)? 'webp' : 'png' ?>" alt="Reference Sheet for Mythic Dawn">
            </div>
            <div class="button-bar">
                <a href="#" class="button large button-noop">
